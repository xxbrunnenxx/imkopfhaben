...
| Up/Down zaehlt am Geraet mit Kontrollton | Am Geraet: hoch zum 420-Track, Klick, Up/Down | **teilbelegt** — Route zeigte genau einen Uebergang 5→6, danach 45 s unberuehrt konstant 6 (kein Auto-Increment). Der Pfad Taste→+1→NVS→Route ist damit indirekt belegt; der Tastendruck selbst kam vom Besitzer am Board, nicht von mir, und die Kontrollton-/Fokus-Optik ist noch nicht bestaetigt | 20.09. |
